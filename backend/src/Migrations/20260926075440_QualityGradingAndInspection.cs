...
{
    /// <inheritdoc />
    public partial class QualityGradingAndInspection : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    CollectionCentreId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionCentres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionCentres_Regions_RegionId",
                        column: x => x.RegionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeDiscrepancyFlags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradeDiscrepancyFlags_Inspections_InspectionId",
                        column: x => x.InspectionId,
                        principalTable: "Inspections",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GradeDiscrepancyFlags_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GradeDiscrepancyFlags_Users_ResolvedByOfficerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionCentres_RegionId",
                table: "CollectionCentres",
                column: "RegionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeDiscrepancyFlags_InspectionId",
                table: "GradeDiscrepancyFlags",
                column: "InspectionId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeDiscrepancyFlags_ListingId",
                table: "GradeDiscrepancyFlags",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeDiscrepancyFlags_ResolvedByOfficerId",
                table: "GradeDiscrepancyFlags",
